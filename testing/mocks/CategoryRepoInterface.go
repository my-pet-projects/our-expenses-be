...
func (_m *CategoryRepoInterface) DeleteAll(ctx context.Context, filter domain.CategoryFilter) (*domain.DeleteResult, error) {
	ret := _m.Called(ctx, filter)

	var r0 *domain.DeleteResult
	if rf, ok := ret.Get(0).(func(context.Context, domain.CategoryFilter) *domain.DeleteResult); ok {
		r0 = rf(ctx, filter)
	} else {
		if ret.Get(0) != nil {
...
func (_m *CategoryRepoInterface) DeleteOne(ctx context.Context, id string) (*domain.DeleteResult, error) {
